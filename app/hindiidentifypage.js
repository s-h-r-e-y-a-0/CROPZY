...
export default function HindiVerification() {
  ...
  const handleNext = () => {
    // Navigate to the Hindi plant identification page
    router.push("/hindiidentifypage");
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white", alignItems: "center", padding: 20 }}>
      ...
      <View style={{ 
        ...
        />
        {phone.length > 0 && <Ionicons name="checkmark-circle" size={20} color="#50C878" />}
      </View>
      ...
      >
        <Text style={{ fontSize: 18, fontWeight: "600", color: "#50C878" }}>अगला</Text>
        <View style={{ width: 60, height: 1, backgroundColor: "#50C878", marginTop: 4 }} />
      </TouchableOpacity>
